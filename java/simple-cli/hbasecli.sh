...
java -classpath target/classes:${CPATH} -Xbootclasspath/p:${LOCAL_REPOSITORY}/org/mortbay/jetty/alpn/alpn-boot/${ALPN_VERSION}/alpn-boot-${ALPN_VERSION}.jar com.google.anviltop.sample.HBaseCLI $@
