...
export JETTY_HOME=${RUNTIME_DIR}
export JETTY_VERSION=9.2.10.v20150310
...
/usr/bin/java  \
-Xbootclasspath/p:${JETTY_HOME}/lib/alpn/alpn-boot-7.1.3.v20150130.jar \
${JAVA_OPTS} ${DBG_AGENT} ${PROF_AGENT} \
