...
interface JobOptions extends DataflowPipelineOptions {
  @Required
  @Description("A file path pattern to a set of files that contains row prefixes")
  ValueProvider<String> getRegexFile();
  void setRegexFile(ValueProvider<String> path);
